(function () {
  ...
  function rmTimeInput2($filter, rmTimeInputConfig, $parse) {
    return {
      restrict: "A",
      require: '?^ngModel',
      scope: {},
      link: function (scope, element, attrs, ngModel) {
        ...
        ngModel.$formatters.push(function (value) {
          var fmtValue = $filter('date')(value, 'HH:mm');
          return fmtValue;
        });
  ...
  function rmTimeInput($filter, rmTimeInputConfig, $parse) {
    ...
    var customFloor = function(value, roundTo) {
      return Math.floor(value / rmTimeInputConfig.minuteStep) * rmTimeInputConfig.minuteStep;
    };
    ...
    return {
      ...
      link: function(scope, element, attrs, ngModel) {
        ...
        //this seems to break it for newer versions of angular, not sure why??
        //ngModel.$render = function () {
        //
        //};

        var minuteStep = getValue(attrs.minuteStep, rmTimeInputConfig.minuteStep),
            fixedDay = getValue(attrs.fixedDay, rmTimeInputConfig.fixedDay),
            timeFormat = attrs.format || rmTimeInputConfig.format,
            maxDate = null,
            minDate = null;
        ...
        function formatter(value) {
          if (value) {
            var fmtValue = $filter('date')(value, timeFormat);
            return fmtValue;
          }
        }
  ...
  angular
    .module('rm')
    .value('rmTimeInputConfig', rmTimeInputConfig)
    .directive('rmTimeInput', rmTimeInput);
})();